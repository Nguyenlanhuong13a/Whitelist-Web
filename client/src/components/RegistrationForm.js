    ...
    <div className="glass-strong rounded-2xl shadow-glass overflow-hidden animate-fade-in">
      <div className="bg-gradient-to-r from-primary-600/20 to-secondary-600/20 border-b border-dark-700/50 p-8">
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-gray-400 mt-1">Điền đầy đủ thông tin bên dưới để đăng ký</p>
          </div>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="p-8 space-y-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div>
            <label htmlFor="steam" className="block text-sm font-medium text-gray-300 mb-1">Steam ID <span className="text-red-500">*</span></label>
            <div className="relative">
              ...
              <input 
                ...
                id="steam" 
                name="steam" 
                placeholder="Ví dụ: STEAM_0:1:12345678" 
                value={formData.steam}
                onChange={handleChange}
                className={`input-field pl-10 ${errors.steam ? 'border-red-500 focus:border-red-500 focus:ring-red-500' : ''}`}
              />
            </div>
            {errors.steam && <p className="mt-1 text-sm text-red-500">{errors.steam}</p>}
          </div>
        </div>
        
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            <label htmlFor="name" className="block text-sm font-medium text-gray-300 mb-1">Tên nhân vật trong game <span className="text-red-500">*</span></label>
            <input 
              type="text" 
              id="name" 
              name="name" 
          ...
          <div>
            <label htmlFor="birthDate" className="block text-sm font-medium text-gray-300 mb-1">Ngày tháng năm sinh <span className="text-red-500">*</span></label>
            <input 
              type="date" 
              id="birthDate" 
              name="birthDate" 
              ...
              className={`input-field ${errors.birthDate ? 'border-red-500 focus:border-red-500 focus:ring-red-500' : ''}`}
            />
            {errors.birthDate && <p className="mt-1 text-sm text-red-500">{errors.birthDate}</p>}
            <p className="mt-1 text-xs text-gray-500">Bạn phải từ 16 tuổi trở lên</p>
          </div>
        </div>
        
        <div>
          <label htmlFor="backstory" className="block text-sm font-medium text-gray-300 mb-1">Tiểu sử nhân vật <span className="text-red-500">*</span></label>
          <div className="relative">
            <textarea 
              id="backstory" 
              name="backstory" 
              ...
              onChange={handleChange}
              className={`input-field ${errors.backstory ? 'border-red-500 focus:border-red-500 focus:ring-red-500' : ''}`}
            ></textarea>
          </div>
          <div className="flex justify-between items-center mt-1">
            {errors.backstory && <p className="text-sm text-red-500">{errors.backstory}</p>}
        ...
        <div>
          <label htmlFor="reason" className="block text-sm font-medium text-gray-300 mb-1">Lý do muốn tham gia máy chủ <span className="text-red-500">*</span></label>
          <textarea 
            id="reason" 
            name="reason" 
            rows="3" 
